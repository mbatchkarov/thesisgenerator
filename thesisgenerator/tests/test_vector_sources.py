...
all_features = unigram_feature | bigram_feature | an_feature
...
class TestUnigramVectorSource(TestCase):
    ...
    def test_accept_features(self):
        ...
        """
        self.assertSetEqual(
            self.source.accept_features(all_features),
            unigram_feature
        )
...
class TestCompositeVectorSource(TestCase):
    def setUp(self):
        self.conf = {
            ...
            'thesisgenerator.composers.vectorstore.BaroniComposer': {
                'run': True,
                'file_path': '/mnt/lustre/scratch/inf/mmb28/FeatureExtrationToolkit/exp6-12c/'}
        }
    ...
    def test_also_include_unigram_features(self):
        ...
        source = CompositeVectorSource(self.conf)
        self.assertSetEqual(source.accept_features(all_features), all_features)
    ...
    def test_include_unigram_features_only(self):
        ...
        self.assertSetEqual(source.accept_features(all_features), unigram_feature)