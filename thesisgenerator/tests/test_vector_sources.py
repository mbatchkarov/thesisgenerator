...
def small_vectors():
    return Vectors.from_tsv('thesisgenerator/resources/thesauri/small.txt.events.strings')


@pytest.fixture
def vectors_a():
    return Vectors.from_tsv('thesisgenerator/resources/exp0-0a.strings')
...
@pytest.fixture
def ones_vectors():
    return Vectors.from_tsv('thesisgenerator/resources/ones.vectors.txt')
