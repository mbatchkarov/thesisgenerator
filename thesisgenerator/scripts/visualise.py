...
table_descr = {
    ...
    42: 'AN_NN, Add, signified, gigaw',
    43: 'AN_NN, Mult, signified, gigaw',
    44: 'AN_NN, Left, signified, gigaw',
    45: 'AN_NN, Right, signified, gigaw',
    46: 'AN_NN, Min, signified, gigaw',
    47: 'AN_NN, Max, signified, gigaw',
    48: 'AN_NN, Observed, signified, gigaw',
    49: 'AN_NN, Add, signified, wiki',
    50: 'AN_NN, Mult, signified, wiki',
    51: 'AN_NN, Left, signified, wiki',
    52: 'AN_NN, Right, signified, wiki',
    53: 'AN_NN, Min, signified, wiki',
    54: 'AN_NN, Max, signified, wiki',
    55: 'AN_NN, Observed, signified, wiki',
    56: 'AN_NN, Add, signified, gigaw',
    57: 'AN_NN, Mult, signified, gigaw',
    58: 'AN_NN, Left, signified, gigaw',
    59: 'AN_NN, Right, signified, gigaw',
    60: 'AN_NN, Min, signified, gigaw',
    61: 'AN_NN, Max, signified, gigaw',
    62: 'AN_NN, Observed, signified, gigaw',
    63: 'AN_NN, Add, signified, wiki',
    64: 'AN_NN, Mult, signified, wiki',
    65: 'AN_NN, Left, signified, wiki',
    66: 'AN_NN, Right, signified, wiki',
    67: 'AN_NN, Min, signified, wiki',
    68: 'AN_NN, Max, signified, wiki',
    69: 'AN_NN, Observed, signified, wiki',

    70: 'AN, Add, signified, gigaw',
    71: 'AN, Mult, signified, gigaw',
    72: 'AN, Left, signified, gigaw',
    73: 'AN, Right, signified, gigaw',
    74: 'AN, Min, signified, gigaw',
    75: 'AN, Max, signified, gigaw',
    76: 'AN, Observed, signified, gigaw',
    77: 'NN, Add, signified, gigaw',
    78: 'NN, Mult, signified, gigaw',
    79: 'NN, Left, signified, gigaw',
    80: 'NN, Right, signified, gigaw',
    81: 'NN, Min, signified, gigaw',
    82: 'NN, Max, signified, gigaw',
    83: 'NN, Observed, signified, gigaw',
}
...
experiment_sets = [
    ...
    # todo observed baseline missing
    range(42, 48), # all composed NP thesauri, giga, R2
    range(49, 55), # all composed NP thesauri, wiki, R2
    range(56, 62), # all composed NP thesauri, giga, MR
    range(63, 69), # all composed NP thesauri, wiki, MR
    range(70, 76), # composed AN thesauri, giga, R2
    range(77, 83), # composed NN thesauri, giga, R2
    ...
    [46, 74, 81],
    [47, 75, 82],
    # [48, 76, 83], # todo observed result missing
]
