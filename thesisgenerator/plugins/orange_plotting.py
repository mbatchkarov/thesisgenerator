...
def graph_ranks(scores, names, get_linked_methods,
    ...
    lines = merge_nonsignificant_cliques(get_linked_methods(ssums))
...
if __name__ == "__main__":
    avranks = numpy.array([31.43, 20.00, 28.93, 19.64, 25, 33.4])
    names = ["prva", "druga", "tretja", "cetrta", 'peta', 'shesta']
    fig = graph_ranks(avranks, names, my_get_lines)
